...
import { ArrowRight, Eye, EyeOff, Lock, User, Mail, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-tr from-[#02050f] via-[#040816] to-[#0a0f29] flex items-center justify-center p-6 select-none font-sans">
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-xs mt-1">Start your journey to mental clarity.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full glow-btn text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 text-sm mt-6"
          >
